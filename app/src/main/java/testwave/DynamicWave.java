...
public class DynamicWave extends View {
    ...
    // 波纹颜色
    private static final int WAVE_PAINT_COLOR = 0xEEF4A460;
    // y = Asin(wx+b)+h
    ...
    private void startObjectAnimation() {
        ObjectAnimator animation = ObjectAnimator.ofFloat(this, "gap", 0, level);
        animation.setDuration((int) (4000 * level / 10));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            // 绘制第一条水波纹
            canvas.drawLine(i, mTotalHeight - mResetOneYPositions[i] - gap / 10f * mTotalHeight, i, mTotalHeight, mWavePaint);

            // 绘制第二条水波纹
            canvas.drawLine(i, mTotalHeight - mResetTwoYPositions[i] - gap / 10f * mTotalHeight, i, mTotalHeight, mWavePaint);
