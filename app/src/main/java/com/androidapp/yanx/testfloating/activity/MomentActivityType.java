...
import com.androidapp.yanx.testfloating.adapter.MomentAdapterType;
 ...
 * ****************************************************************************
 **/
public class MomentActivityType extends AppCompatActivity {
    Toolbar toolBar;

    RecyclerView recyclerView;

    MomentAdapterType adapter;
...
//        adapter.notifyItemInserted(2);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MomentAdapterType(this, mBlogs);
